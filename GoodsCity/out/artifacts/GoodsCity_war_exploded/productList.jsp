...
<div class="address">
    <div class="wrapper clearfix"><a href="indexServlet">首页</a><span>/</span><a
            href="flowerDer.html">小雨辰</a><span>/</span><a href="proList.jsp" class="on">${title}</a>
    </div>
</div>
<!-------------------current---------------------->
<div class="current">
...
<ul class="proList wrapper clearfix">
    ...
    <c:forEach items="${list}" var="prol">
    <li><a href="selectProView?id=${prol.PRODUCT_ID}">
        <dl>
            <dt><img src="img/temp/${prol.PRODUCT_FILENAME}"></dt>
            <dd>${prol.PRODUCT_NAME}</dd>
            <dd>${prol.PRODUCT_PRICE}</dd>
        </dl>
    </a></li>
    </c:forEach>
