    ...
    <div class="orderCon wrapper clearfix">
        <div class="orderL fl"><!--------h3----------------><h3>收件信息<a href="#" class="fr">新增地址</a></h3>
            ...
            <div class="addres clearfix">
                <div class="addre fl on">
                    <div class="tit clearfix"><p class="fl">${userInfo.USER_NAME} <span class="default">[默认地址]</span></p>
                        <p class="fr"><a href="#">删除</a><span>|</span><a href="#" class="edit">编辑</a></p></div>
                    <div class="addCon"><p>${userInfo.USER_ADDRESS}</p>
                        <p>${userInfo.USER_MOBILE}</p></div>
                </div>

                <div class="addre fl">
                    <div class="tit clearfix"><p class="fl">${userInfo.USER_NAME}</p>
        ...
        <div class="orderR fr">
            ...
            <c:forEach var="rs" items="${shopList}">
                <ul class="clearfix">
                    <li class="fl"><img width="100" height="100" src="img/temp/${rs.cart_p_filename}"></li>
            ...
            <div class="tips"><p><span class="fl">商品金额：</span><span class="fr">￥${allMoney}.00</span></p>
                <p><span class="fl">优惠金额：</span><span class="fr">￥0.00</span></p>
                <p><span class="fl">运费：</span><span class="fr">免运费</span></p></div><!--------tips count---------------->
            <div class="count tips"><p><span class="fl">合计：</span><span class="fr">￥${allMoney}.00</span></p></div>
